...
filename = 'cargaMetalprotec/facturasProductosMetalprotec.csv'
...
with open(filename, 'r') as csv_file:
    ...
    for row in reader:
        ...
        origenFactura = 'GUIDE'
        asociatedQuotation = None
        guideObject = guideSystem.objects.get(codeGuide=row[10])

        itemFactura = 'PRODUCTOS'
        ...
        guideObject.asociatedBill = infoFactura
        guideObject.save()
